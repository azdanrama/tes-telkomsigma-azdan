...
<html class="no-js">
	...
	<title>Contact Us | PT Sigma Cipta Caraka | TELKOMSIGMA</title>
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'kontak'?>">Contact Us</a></li>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/contact-us.jpg'?>);">
