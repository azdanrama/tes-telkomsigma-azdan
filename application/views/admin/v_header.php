...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="" class="logo" style="background-color: #C8160F">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">TS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">TELKOMSIGMA</span>
    </a>

    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color: #E41A12">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="background-color: #E41A12">
