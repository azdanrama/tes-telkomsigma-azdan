...
<head>
  ...
  <title>TELKOMSIGMA | Categories</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/kategori'?>"><i class="fa fa-wrench"></i> Categories</a></li>
          </ul>
        </li>
<!-- 
        <li class="treeview">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://www.linkedin.com/in/azdanrama/">Azdan Vila Ramadhani</a>.</strong> All rights reserved.
  </footer>
